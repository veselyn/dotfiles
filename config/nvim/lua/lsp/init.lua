...
local on_attach = function(client, bufnr)
    ...
    buf_set_keymap('n', '\\gs', '<Cmd>lua vim.lsp.buf.document_symbol()<CR>',
                   opts)
    buf_set_keymap('n', '\\gS', '<Cmd>lua vim.lsp.buf.workspace_symbol()<CR>',
                   opts)
    ...
    buf_set_keymap('n', '\\d',
                   ...
                   opts)
    buf_set_keymap('n', '\\D', '<Cmd>lua vim.lsp.diagnostic.set_loclist()<CR>',
                   opts)
